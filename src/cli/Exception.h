...
public:
   ...
   static std::string getErrorCodeString(ErrorCode errorCode)
   {
      switch(errorCode)
      {
         ...
         case DEVICE_MULTIPLE_EDL_DEVICES:
            return "Multiple devices in EDL";
         case PROTOCOL_ERROR:
   ...
   static std::string getErrorCodeName(ErrorCode errorCode)
   {
      switch(errorCode)
      {
         ...
         case DEVICE_MULTIPLE_EDL_DEVICES:
            return "DEVICE_MULTIPLE_EDL_DEVICES";
         case PROTOCOL_ERROR:
...
private:
   ...
   static std::string getDeviceSuggestion(ErrorCode errorCode)
   {
      switch(errorCode)
      {
         ...
         case DEVICE_MULTIPLE_EDL_DEVICES:
            return "Multiple EDL devices found, please re-run command with --device param";
         default:
            return "";
      }
   }
