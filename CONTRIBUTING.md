# Contributing to <qcom-image-loader>
...
1. [Fork](https://github.com/qualcomm/<qcom-image-loader>/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/<qcom-image-loader>.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/<qcom-image-loader>.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/qcom-image-loader/pulls) from your branch to `main`.
